...
# Mule Kick: sfdc2sfdc-accounts-aggregation
...
Once your app is all set and started, supposing you choose as domain name `sfdc2sfdc-accounts-aggregation` to trigger the use case you just need to hit `http://sfdc2sfdc-accounts-aggregation.cloudhub.io/synccontacts` and report will be sent to the emails configured.
