 ...
 */
public class SFDCAccountMergeAggregationStrategy implements AggregationStrategy {
	...
	public MuleEvent aggregate(AggregationContext context) throws MuleException {
		...
		List<Map<String, String>> mergedAccountList = sfdcAccountMerge.mergeList(listA, listB);
